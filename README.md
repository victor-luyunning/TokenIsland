...
TokenIsland 常驻 macOS 菜单栏，点击图标后展开用量面板。顶部显示所选日期的总 token、费用和缓存命中率，中间是 24 小时用量曲线，底部提供 7 天 token 趋势。

面板支持按模型和按类型两种视图查看当日用量分布：

<p align="center">
  <img src="docs/screenshots/tokenisland-by-model.png" alt="TokenIsland 按模型展示用量" width="360">
  <img src="docs/screenshots/tokenisland-by-type.png" alt="TokenIsland 按类型展示用量" width="360">
</p>
...
从 [Releases](https://github.com/victor-luyunning/TokenIsland/releases) 下载 `TokenIsland-v0.1.0-macOS.zip`，解压后拖进 `Applications` 文件夹。
...
```bash
git clone https://github.com/victor-luyunning/TokenIsland.git
cd TokenIsland
